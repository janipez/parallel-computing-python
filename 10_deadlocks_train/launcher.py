...
# from deadlock.train import * # Deadlock happens
# from hierarchy.train import * # Solve deadlock by always locking lowest lock/intersection_id first
from arbitrator.train import * # Solve deadlock by 3rd party - arbitrator, who tells if all locks/intersection_ids are available
